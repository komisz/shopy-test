        ...
        <div class="product-info">
          ...
          <section>
            <div class="fourth">
              ...
              <button class="open-cart-btn" type="button">
...
//    <select data-key="size">
//      ${this.createOptions(sizes, this.currentOptions.size)}
//    </select>
//    <label for="color-select">Select color:</label>
//    <select data-key="color">
//      ${this.createOptions(colors, this.currentOptions.color)}
//    </select>
//  </div>;
